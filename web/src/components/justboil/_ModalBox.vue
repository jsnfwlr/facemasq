<script setup>
  ...
  import JbButtons from "@/components/justboil/_JbButtons.vue"
  import CardComponent from "@/components/justboil/CardComponent.vue"
  import Overlay from "@/components/justboil/_Overlay.vue"
...
<template>
  <overlay v-show="value" @overlay-click="cancel">
    <card-component v-show="value" :title="title" class="shadow-lg w-full max-h-modal md:w-3/5 lg:w-2/5 z-50" :header-icon="mdiClose" @header-icon-click="cancel">
      <div class="space-y-3">
